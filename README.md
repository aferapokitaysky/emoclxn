...
**EMO CLXN** — официальный, премиальнальная капт фама
** в GTA 5 RP**. Этот сайт создан как интерактивное визуальное заявление: сочетание темной готической эстетики, жидкого хрома, глитч-эффектов Y2K и передовых фронтенд-анимаций.
...
* **⛪ Готический брендинг и Pirata One**:
  ...
  * Надпись `emoclxn` выполнена брутальным средневековым готическим шрифтом **`Pirata One`**, подчеркивающим суровый стиль cyber-sigilism и тяжелого металла.
...
* **🔝 Смарт-Шапка (Smart Auto-Hide Header)**:
  * Навигационная панель автоматически скрывается при скролле вниз, освобождая игровое пространство.
...
* **📈 Анимированные счетчики опыта**:
  * Анимированный дашборд с триггером скролла (`IntersectionObserver`), который считает до целевых значений:
    ...
    * `80%` WINRATE
* **📊 Аналитика и Разделы**:
  * Интегрирован официальный Google Analytics поток с Measurement ID **`G-N6PPVZF19P`**.
  * Структурированные разделы **«Контакты»** (с большими карточками Discord/YouTube) и **«Вступить»** (подача заявок).
